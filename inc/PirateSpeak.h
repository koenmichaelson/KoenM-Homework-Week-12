...
class Pirate {
    public:
        string translateWord(string word){
            ...
            ifstream fin("C:\\Users\\koenm\\source\\repos\\KoenM-Homework-Week-12\\files\\pirate.csv", ios::in);
        ...
        void addToFile(string english, string pirate){
            ...
            ofstream fout("C:\\Users\\koenm\\source\\repos\\KoenM-Homework-Week-12\\files\\pirate.csv", ios::app);
